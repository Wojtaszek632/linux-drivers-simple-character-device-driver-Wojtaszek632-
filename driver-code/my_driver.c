...
static int calculator(int val1, int val2, operation_t desiredOperation)
{
...
static long my_ioctl (struct file *file, unsigned int cmd,unsigned long arg)
{
	...
	pr_info("IOCTL RECIEVED: %d %d\n",mid.val1,mid.val2);
	pr_info("K Reading IOCTL successfull\n");
	
	mostRecentResult = calculator(mid.val1,mid.val2,mid.desiredOperation);
	return 0;
}
